...
const Sankey = props => {
  ...
  /**
   * the function is passed two nodes, and must return a value
   * - less than 0 if the first node should be above the second
   * - greater than 0 if the second node should be above the first
   * - 0 if the order is not specified
   * @param {*} node1
   * @param {*} node2
   */
  const nodeSortFunc = (node1, node2) => {
